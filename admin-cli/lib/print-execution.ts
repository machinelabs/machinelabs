...
export const printExecution = (execution: Execution) =>
  console.log(`
${execution.id}      ${execution.lab.id}     ${execution.user_id}      ${moment
    .utc(execution.started_at)
    .format(DATE_FORMAT)}       ${prettyPrintDuration(Date.now() - execution.started_at)}       ${execution.server_info}
-------------------------------------------------------------------------------------------------------------------------------------`);
