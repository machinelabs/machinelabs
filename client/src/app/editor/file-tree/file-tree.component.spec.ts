...
describe('FileTreeComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [{ provide: EditorService, useValue: EDITOR_SERVICE_STUB }, NameDialogService, FileTreeService],
  ...
  describe('.isRemovable()', () => {
    it('should not only allow removal of blacklisted files', () => {
      component.directory = {
        name: '',
        contents: [{ name: 'main.py', content: '' }, { name: 'second.py', content: '' }]
      };
  ...
  describe('.getFileTreePath()', () => {
    it('should generate file path based on file tree structure', () => {
      ...
      const nestedList = fixture.debugElement.query(By.css('ml-file-tree ml-file-tree ml-file-tree'));
  ...
  it('should render a nested list of files', () => {
    ...
    const lists = fixture.debugElement.queryAll(By.css('ml-file-tree'));
    expect(lists.length).toEqual(2);

    const nestedList = lists[0].queryAll(By.css('ml-file-tree'));
  ...
  it('should not render a nested list if folder is empty', () => {
    component.directory = {
      ...
      contents: [
        {
          name: 'folder',
          contents: [{ name: 'main.py', content: '' }, { name: 'folder2', contents: [] }]
        }
      ]
    };
  ...
  it('should select file including its path if item is nested', () => {
    ...
    const expectedFile = { name: 'foo.py', content: '' };
    const expectedPath = '/folder/folder2/foo.py';
    component.directory = {
      name: '',
      contents: [
        {
          name: 'folder',
          contents: [{ name: 'main.py', content: '' }, { name: 'folder2', contents: [expectedFile] }]
        }
      ]
    };
    ...
    const item = fixture.debugElement.query(By.css('ml-file-tree ml-file-tree .ml-file-tree-item'));
  ...
  it('should not try to select file when clicked list item represents a folder', () => {
    ...
    component.directory = {
      ...
      contents: [
        {
          name: 'src',
          contents: [{ name: 'foo.py', content: '' }, { name: 'bar.py', content: '' }]
        }
      ]
    };
    fixture.detectChanges();
    const items = fixture.debugElement.queryAll(By.css('.ml-file-tree-item'));
  ...
  it("shouldn't select file when edit or delete button is clicked", () => {
    ...
    fixture.detectChanges();
    const editButton = fixture.debugElement.query(By.css('.ml-file-tree-item-button.edit'));
    const deleteButton = fixture.debugElement.query(By.css('.ml-file-tree-item-button.delete'));
  ...
  it("shouldn't render edit button for files that aren't editable", () => {
    ...
    fixture.detectChanges();
    const items = fixture.debugElement.queryAll(By.css('.ml-file-tree-item'));
    const editButton = items[0].queryAll(By.css('.ml-file-tree-item-button.edit'));
  ...
  it('should not render action buttons if configured that way', () => {
    ...
    fixture.detectChanges();
    const buttons = fixture.debugElement.queryAll(By.css('.ml-file-tree-item-button'));
  ...
  it('should have a reference to parent file list if nested', () => {
    ...
    const nestedList = fixture.debugElement.query(By.css('ml-file-tree'));
