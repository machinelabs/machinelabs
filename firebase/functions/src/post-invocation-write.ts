...
import { getServerIdForHardwareType, getServerIdFromExecution } from './invocation-processor/server-resolver/resolve-strategies';
...
export const postInvocationWrite = functions.database.ref('/invocations/{id}/common/id')
